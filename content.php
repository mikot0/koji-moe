				...
				<nav class="pagination-single<?php echo $pagination_classes; ?>">
						...
						<a class="previous-post" href="<?php echo esc_url(get_permalink($prev_post->ID)); ?>">
							<span class="arrow">
								<img aria-hidden="true"
									src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/chevron-left.svg" />
					...
					<?php if ($next_post): ?>
						...
						<a class="next-post" href="<?php echo esc_url(get_permalink($next_post->ID)); ?>">
							<span class="arrow">
								<img aria-hidden="true"
									src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/chevron-right.svg" />
								<span class="screen-reader-text"><?php _e('', ''); ?> </span>
							</span>
